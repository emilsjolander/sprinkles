...
public final class OneQuery<T extends Model> {
	...
	public void getAsyncWithUpdates(LoaderManager lm,
			OnQueryResultHandler<T> handler, Class<? extends Model>... respondsToUpdatedOf) {
	...
	public void getAsync(android.support.v4.app.LoaderManager lm, OnQueryResultHandler<T> handler) {
		final int loaderId = sqlQuery.hashCode();
		lm.initLoader(loaderId, null,
